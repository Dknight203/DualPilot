...
const FooterLink: React.FC<{ href: string, children: React.ReactNode }> = ({ href, children }) => (
    <li>
        <Link to={href} className="text-slate-600 hover:text-[#0A66C2]">
            {children}
        </Link>
    </li>
);
        ...
        <footer className="border-t border-slate-100 bg-white">
            <div className="max-w-[1100px] mx-auto px-4 sm:px-6">
                <div className="py-12">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        <div className="lg:col-span-4">
                            <h4 className="font-semibold text-lg text-slate-800">Rank on Google. Show up in AI.</h4>
                ...
                <div className="border-t border-slate-100 py-6">
                    <p className="text-center text-sm text-slate-600">© {new Date().getFullYear()} DualPilot, Inc. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
